    ...
    <div className=" flex  ">
      ...
      >
        ...
        <div className="flex flex-col pt-5">
          ...
          <Link href="./Images/cv.pdf" target="_blank" className="mt-5 ">
            <button className="flex items-center px-3 text-lg py-2 rounded-lg bg-gradient-to-r from-cyan-600 to-blue-600  font-semibold hover:opacity-85 hover:scale-105">
